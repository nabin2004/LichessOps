...
\repo{libs/shared/storage_config.py} & DuckDB and S3 URI mapping \\
...
\repo{packages/lichess_data/src/lichess_data/load/duckdb_sync.py} & Parquet $\rightarrow$ DuckDB sync \\
