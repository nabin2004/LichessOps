"""Tests for libs.shared.s3 helpers."""
...
def moto_s3(monkeypatch):
    ...
    with mock_aws():
        ...
        from libs.shared import s3 as s3mod
...
def test_upload_and_object_exists(tmp_path: Path, moto_s3, monkeypatch):
    from libs.shared.s3 import object_exists, upload_file
