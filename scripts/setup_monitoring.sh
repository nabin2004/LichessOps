...
echo ""
echo "The full pipeline starts monitoring automatically:"
echo "  ./scripts/run_pipeline_2013_01.sh"
echo ""
echo "Or start serving manually (container):"
echo "  docker compose --profile serving up -d lichess-serving"
